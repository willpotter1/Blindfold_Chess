    ...
    extend: {
      colors: {
        ...
        board: {
          ...
          border: "rgb(var(--board-border) / <alpha-value>)",
          "label-light": "rgb(var(--board-label-light) / <alpha-value>)",
          "label-dark": "rgb(var(--board-label-dark) / <alpha-value>)",
          select: "rgb(var(--board-select) / <alpha-value>)",
          highlight: "rgb(var(--board-highlight) / <alpha-value>)",
          correct: "rgb(var(--board-feedback-correct) / <alpha-value>)",
          wrong: "rgb(var(--board-feedback-wrong) / <alpha-value>)",
        },
        surface: {
